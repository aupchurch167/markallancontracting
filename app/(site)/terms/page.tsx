...
export default function TermsPage() {
  return (
    <>
      ...
      <Section>
        <div className="mx-auto max-w-prose space-y-6 text-body">
          <p>
          ...
          <h2 className="text-xl font-bold text-ink">No professional reliance</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-ink">Disclaimer & limitation of liability</h2>
          <p>
          ...
          <p>
            ...
            or <a href={`tel:${CONTACT.phoneRaw}`} className="text-maroon hover:text-maroon-dark">{CONTACT.phone}</a>.
          </p>

          <p className="text-sm text-faint">
            See also our{' '}
            <Link href="/privacy" className="text-maroon hover:text-maroon-dark">Privacy Policy</Link>.
          </p>
        </div>
      </Section>
    </>
